        ...
        VStack {
                    ...
                    HStack {
                        VStack {
                            Button(action: {
                                ...
                                Coin(coinCode: math.coinIHave).coinImage.resizable()
                                    .frame(width: 32, height: 32)
                                    .cornerRadius(30)
                                    .addBorder(Color.white, width: 1, cornerRadius: 60)
                            }
                            
                            Text(math.coinIHave).foregroundColor(.orange)
                                .animation(.default)
                    ...
                    HStack {
                        VStack {
                            Button(action: {
                                ...
                                Coin(coinCode: math.coinIWant).coinImage.resizable()
                                    .frame(width: 32, height: 32)
                                    .cornerRadius(30)
                                    .addBorder(Color.white, width: 1, cornerRadius: 60)
                            }
                            
                            Text(math.coinIWant).foregroundColor(.red)
                                .animation(.default)
                                .padding(.bottom, 20)
                ...
                HStack  {
                    ...
                    VStack {
                        ...
                        Text("\(Constants.one) \(math.coinIHave) = \(math.coinValueText()) \(math.coinIWant)").foregroundColor(Color.gray)
                    }
                    Spacer()
                    Button(action: {
